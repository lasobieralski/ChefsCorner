...
// new login.js
// Handles login and signup modal logic
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (openSignupFormBtn && signupFormContainer) {
    ...
    if (loginForm) {
      loginForm.addEventListener("submit", (e) => {
        ...
        // Simple validation (could expand this)
        if (username && password) {
          localStorage.setItem("currentUser", username);
  
          // Redirect to My Recipes after login
    ...
    if (signupForm) {
      signupForm.addEventListener("submit", (e) => {
        ...
        if (username && email && password) {
          // Simulate account creation by just storing user
          localStorage.setItem("currentUser", username);
